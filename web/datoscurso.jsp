...
<html>
    ...
    <body>
        <%
            try{
                ...
                if(s_accion!=null && s_accion.equals("M1")){
                    consulta = "    select codigo, nombres, horas, creditos, estado  "
                                + " from curso "
                                + " where"
                                + " idcurso = " + s_idcurso + "; ";
                    //out.print(consulta);
        ...
        <form name="EditarCursoForm" action="datoscurso.jsp" method="GET">
            <table border="0" align="center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Nombres: </td>
                        <td><input type="text" name="f_nombres" value="<% out.print(rs.getString(2)); %>" maxlength="40" size="20" /></td>
                    </tr>
                    <tr>
                        <td>Horas: </td>
        ...
        <%
                ...
                if (s_accion!=null) {
                    if (s_accion.equals("E")) {
                        ...
                        consulta =  "   insert into "
                                    + " curso(nombres, codigo, horas, creditos, estado) "
                                    + " values ('"+ s_nombres +"','"+ s_codigo +"','"+ s_horas +"','"+ s_creditos +"','"+ s_estado +"')";
                        //out.print(consulta);
                        pst = cn.prepareStatement(consulta);
                        pst.executeUpdate();
                ...
                consulta= " Select idcurso, codigo, nombres, horas, creditos, estado "
                        + " from curso ";
                //out.print(consulta);
                pst = cn.prepareStatement(consulta);
                rs = pst.executeQuery();
